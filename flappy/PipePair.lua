...
local GAP_HEIGHT = 90
-- new code: Randomely generated gap height it inbetween 85 and 120 
local GAP_HEIGHT_RANDOM =  PIPE_HEIGHT + math.random(GAP_HEIGHT-5, GAP_HEIGHT +30)
...
function PipePair:init(y)
    ...
    self.pipes = {
        ...
        ['lower'] = Pipe('bottom', self.y + GAP_HEIGHT_RANDOM)
    }
